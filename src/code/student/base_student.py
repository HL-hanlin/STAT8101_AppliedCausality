...
class BaseStudent(SerializableAgent):
    ...
    def test(self, num_episodes, env_wrapper, verbose=True, print_period = 1, brief = False):
        self.test_mode = True
        ...
        for episode_index in range(num_episodes):
            ...
            if verbose:
                if episode_index % print_period ==0:
                    if brief:
                        print('\repoch {}/{} return: {}'.format(episode_index, num_episodes, retvrn), end="")
                    else:
                        print('epoch {}/{} return: {}'.format(episode_index, num_episodes, retvrn))
